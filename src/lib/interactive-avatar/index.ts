...
class StreamingAvatar {
  ...
  constructor({
    token,
    socketHost = "api.heygen.com",
    basePath = "https://api2.heygen.com",
  ...
  public async recreateToken(): Promise<any> {
    const { token } = await this.request("/v1/streaming.create_token", {
  ...
  public async newSession(
    ...
    return this.request("/v1/realtime.new", {
  ...
  public async startSession(): Promise<any> {
    return this.request("/v1/realtime.start", {
      session_id: this.sessionId,
    });
  }
  public async speak(requestData: SpeakRequest): Promise<any> {
    ...
    return this.request("/v1/realtime.task", {
      text: requestData.text,
      session_id: this.sessionId,
  ...
  public async startListening(): Promise<any> {
    return this.request("/v1/realtime.start_listening", {
      session_id: this.sessionId,
    });
  }
  public async stopListening(): Promise<any> {
    return this.request("/v1/realtime.stop_listening", {
      session_id: this.sessionId,
    });
  }
  public async interrupt(): Promise<any> {
    return this.request("/v1/realtime.interrupt", {
      session_id: this.sessionId,
    });
  }
  ...
  public async stopAvatar(): Promise<any> {
    ...
    this.closeVoiceChat();
    return this.request("/v1/realtime.stop", {
      session_id: this.sessionId,
    });
  }
  ...
  private async request(
    ...
    try {
      const response = await fetch(this.getRequestUrl(path), {
        method: "POST",
        headers: {
          "x-guest-session-token": `${this.token}`,
  ...
  private async connectWebSocket(requestData: { useSilencePrompt: boolean }) {
    ...
    this.webSocket.addEventListener("message", (event) => {
      ...
      if (eventData) this.emit(eventData.event_type, eventData);
    });
